...
history256 = model256.fit(X_256, y_256, validation_split=0.2, epochs=100, batch_size=32)
...
history512 = model512.fit(X_512, y_512, validation_split=0.2, epochs=100, batch_size=32)
