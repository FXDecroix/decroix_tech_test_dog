...
history256 = model256.fit(X_256, y_256, validation_split=0.2, epochs=10, batch_size=8)
...
history512 = model512.fit(X_512, y_512, validation_split=0.2, epochs=10, batch_size=8)
